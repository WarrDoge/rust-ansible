#!/usr/bin/env python3
"""
Test to see module stdout/stderr.
"""
import sys

print("=== Module Output Test ===")
...
try:
    ...
    print(f'\n--- module_stdout ---')
    print(result.get('module_stdout', '<not set>'))
    print(f'\n--- module_stderr ---')
    print(result.get('module_stderr', '<not set>'))
    print(f'\n--- msg ---')
    print(result.get('msg', '<not set>'))
